...
dataset = np.loadtxt(sys.argv[2],delimiter=",")
...
# np.savetxt("true.csv", target, delimiter=",")

clf = LogisticRegression(penalty=sys.argv[1], max_iter=200, solver="lbfgs", fit_intercept=True, tol=.001)
